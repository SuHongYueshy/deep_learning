...
from Tensorflow import read_data
...
def inference(input_data):
    ...
    output = tf.matmul(input_data, weights) + biases   # matmul 乘
...
def train(input_x, input_y, ephocs = 10, batch_size = 100):
    ...
    entropy_cost = tf.train.GradientDescentOptimizer(0.0003).minimize(cost)   # 使用梯度下降的算法去算cost最小值
